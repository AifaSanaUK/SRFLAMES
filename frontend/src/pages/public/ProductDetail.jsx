            ...
            <div className="w-full md:w-1/2 p-8 sm:p-12 md:p-16 flex flex-col">
              ...
              <div className="mt-auto flex flex-row gap-2 sm:gap-4">
                ...
                <a
                  ...
                  className="w-1/2 group relative overflow-hidden border-2 border-secondary text-secondary hover:bg-secondary hover:text-white font-black py-3 sm:py-5 rounded-2xl transition-all shadow-md hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 flex justify-center items-center gap-1.5 sm:gap-3 text-[9px] sm:text-[11px] uppercase tracking-[0.15em] sm:tracking-[0.2em] text-center"
                >
                  <Phone className="w-3.5 h-3.5 sm:w-[18px] sm:h-[18px] group-hover:rotate-12 transition-transform" />
                  Call Now
                </a>
                ...
                <button
                  ...
                  className="w-1/2 group relative overflow-hidden bg-secondary text-white font-black py-3 sm:py-5 rounded-2xl transition-all shadow-xl shadow-secondary/20 hover:shadow-primary/30 transform hover:-translate-y-0.5 active:scale-95 flex justify-center items-center gap-1.5 sm:gap-3 text-[9px] sm:text-[11px] uppercase tracking-[0.15em] sm:tracking-[0.2em]"
                >
                  ...
                  <span className="relative flex justify-center items-center gap-1.5 sm:gap-3">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-[#25D366] group-hover:scale-110 transition-transform" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
